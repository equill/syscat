...
def insert_model():
    ...
    # Sites
    post_raw('/sites', data={'uid': 'INM1', "longname": "Innsmouth refinery"})
    post_raw("/sites/INM1/Organisation", data={"target": "/organisations/Marsh_Refinery"})
    ...
    post_ipam('subnets', data={'org': 'Marsh_Refinery', 'subnet': '192.168.0.0/16'})
    #
    ...
    post_ipam('subnets', data={
        ...
        'comments': "Doesn't conflict with the same subnet allocated by Marsh, because it's in a different ASN."
        })
    post_ipam('subnets', data={
        'org': ORG,
        'subnet': '192.0.2.0/28',
    ...
    #
    # Bolton Mills subnet
    post_ipam('subnets', data={'org': 'Bolton_Mills', 'subnet': '10.86.0.0/16'})
